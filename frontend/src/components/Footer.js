...
class Footer extends BaseComponent {
  Content = () => {
    ...
    return (
      <div>
        <div><a href={emailUrl} target='_blank'><img src={emailIconSrc} alt="email"/></a></div>
        <div><a href={phoneUrl} target='_blank'><img src={phoneIconSrc} alt="call me"/></a></div>
        <div><a href={linkedinUrl} target='_blank'><img src={linkedinIconSrc} alt="email"/></a></div>
      </div>
    );
  }
